...
from facefusion.filesystem import filter_audio_paths, get_file_name, is_image, is_video, resolve_file_paths, resolve_file_pattern, find_ffmpeg_path, get_file_format
...
def process_video(start_time : float) -> ErrorCode:
	...
	file_extension = get_file_format(target_path)
	...
	if file_extension!='gif' and analyse_video(state_manager.get_item('target_path'), trim_frame_start, trim_frame_end):
		return 3
